 ...
 */
test('TC_1223: Keyboard Arrow Navigation in Sort Menu', { annotation: { type: 'description', description: 'Verify navigating sort menu items using Up/Down arrow keys and Enter.' } }, async ({ page }) => {
