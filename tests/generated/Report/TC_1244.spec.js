 ...
 */
test('TC_1244: Keyboard Tab Order Across Top Controls', { annotation: { type: 'description', description: 'Verify logical Tab sequence through top controls.' } }, async ({ page }) => {
