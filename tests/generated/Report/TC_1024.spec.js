 ...
 */
test('TC_1024: Hover Expanded Metadata Display', { annotation: { type: 'description', description: 'Verify hovering over a card reveals full contact metadata.' } }, async ({ page }) => {
