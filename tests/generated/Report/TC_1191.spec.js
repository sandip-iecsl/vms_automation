 ...
 */
test('TC_1191: Switch from Card View to List/Table View', { annotation: { type: 'description', description: 'Verify clicking green List View icon switches page to table layout.' } }, async ({ page }) => {
