 ...
 */
test('TC_1224: Logged-in Username Display', { annotation: { type: 'description', description: 'Verify user profile name SANDIPAN TEST renders on top-right navbar.' } }, async ({ page }) => {
