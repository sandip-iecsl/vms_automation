 ...
 */
test('TC_1184: Designation Briefcase Icon Display', { annotation: { type: 'description', description: 'Verify briefcase icon beside Designation text on card hover.' } }, async ({ page }) => {
