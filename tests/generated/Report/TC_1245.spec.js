 ...
 */
test('TC_1245: ARIA Attributes on View Toggle Buttons', { annotation: { type: 'description', description: 'Verify accessibility attributes on view switcher icons.' } }, async ({ page }) => {
