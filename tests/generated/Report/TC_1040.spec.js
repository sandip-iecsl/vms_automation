 ...
 */
test('TC_1040: Fallback \'Not Applicable\' for Missing Event', { annotation: { type: 'description', description: 'Verify cards saved without an assigned event render Not Applicable in Event Name column.' } }, async ({ page }) => {
