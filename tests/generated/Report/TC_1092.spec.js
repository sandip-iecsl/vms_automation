 ...
 */
test('TC_1092: Color Contrast Compliance (WCAG AA)', { annotation: { type: 'description', description: 'Verify contrast ratio between white text/icons and blue avatar badge (W).' } }, async ({ page }) => {
