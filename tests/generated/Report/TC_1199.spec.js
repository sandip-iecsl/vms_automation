 ...
 */
test('TC_1199: Long Designation Text Truncation', { annotation: { type: 'description', description: 'Verify text formatting in Designation column for long role titles.' } }, async ({ page }) => {
