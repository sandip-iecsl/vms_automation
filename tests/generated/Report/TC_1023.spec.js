 ...
 */
test('TC_1023: Default Card Face Display', { annotation: { type: 'description', description: 'Verify default card face displays initial avatar and Company Name.' } }, async ({ page }) => {
