 ...
 */
test('TC_1064: Sort by Company Z-A', { annotation: { type: 'description', description: 'Verify selecting \'Company Z-A\' sorts records alphabetically by Company Name descending.' } }, async ({ page }) => {
