 ...
 */
test('TC_1198: Formatted Phone Number Display', { annotation: { type: 'description', description: 'Verify Phone column renders country codes and spacing cleanly.' } }, async ({ page }) => {
