 ...
 */
test('TC_1036: Switch from List View back to Card View', { annotation: { type: 'description', description: 'Verify clicking blue Card View icon switches layout back to card grid.' } }, async ({ page }) => {
