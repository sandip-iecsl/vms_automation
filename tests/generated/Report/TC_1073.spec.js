 ...
 */
test('TC_1073: Sidebar Collapse Grid Expansion', { annotation: { type: 'description', description: 'Verify cards grid expands smoothly when sidebar is collapsed.' } }, async ({ page }) => {
