 ...
 */
test('TC_1068: Dismiss Sort Menu on Outside Click', { annotation: { type: 'description', description: 'Verify clicking outside sort dropdown dismisses menu.' } }, async ({ page }) => {
