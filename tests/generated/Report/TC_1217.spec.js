 ...
 */
test('TC_1217: Sort by Company A-Z', { annotation: { type: 'description', description: 'Verify selecting \'Company A-Z\' sorts records alphabetically by Company Name ascending.' } }, async ({ page }) => {
