 ...
 */
test('TC_1074: Expand/Collapse Master Accordion', { annotation: { type: 'description', description: 'Verify Master accordion menu toggles smoothly without leaving page.' } }, async ({ page }) => {
