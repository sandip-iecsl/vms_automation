 ...
 */
test('TC_1197: Blank/Empty Data Row Handling', { annotation: { type: 'description', description: 'Verify table rendering when business cards have empty company, name, or phone fields.' } }, async ({ page }) => {
