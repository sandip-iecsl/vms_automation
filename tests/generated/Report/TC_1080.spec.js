 ...
 */
test('TC_1080: Browser Reload Data Retention', { annotation: { type: 'description', description: 'Verify page reload (F5) re-fetches latest business card records cleanly.' } }, async ({ page }) => {
