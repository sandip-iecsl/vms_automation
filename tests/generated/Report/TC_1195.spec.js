 ...
 */
test('TC_1195: Row Selection Focus State', { annotation: { type: 'description', description: 'Verify row highlight feedback when clicking a row in table list view.' } }, async ({ page }) => {
