 ...
 */
test('TC_1194: Table Column Headers Schema', { annotation: { type: 'description', description: 'Verify all 6 table column headers render in exact sequence.' } }, async ({ page }) => {
