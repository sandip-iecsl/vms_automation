 ...
 */
test('TC_1066: Sort by Designation Z-A', { annotation: { type: 'description', description: 'Verify selecting \'Designation Z-A\' sorts records alphabetically by Designation descending.' } }, async ({ page }) => {
