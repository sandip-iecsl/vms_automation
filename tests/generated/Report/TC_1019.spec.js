 ...
 * Description: Verify clicking \'BACK TO HOME\' button redirects to Dashboard.
 */
test('TC_1019: Back to Home Button Action', { annotation: { type: 'description', description: 'Verify clicking \'BACK TO HOME\' button redirects to Dashboard.' } }, async ({ page }) => {
