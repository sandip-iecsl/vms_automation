 ...
 */
test('TC_1067: Sort Persistence Across Views', { annotation: { type: 'description', description: 'Verify applied sort criteria remains active when switching between Card and List view.' } }, async ({ page }) => {
