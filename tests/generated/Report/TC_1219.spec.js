 ...
 */
test('TC_1219: Sort by Designation A-Z', { annotation: { type: 'description', description: 'Verify selecting \'Designation A-Z\' sorts records alphabetically by Designation ascending.' } }, async ({ page }) => {
