 ...
 */
test('TC_1207: Special Characters Search (%, &, /)', { annotation: { type: 'description', description: 'Verify searching company names containing special characters.' } }, async ({ page }) => {
