 ...
 */
test('TC_1193: Fast View Switching Stability', { annotation: { type: 'description', description: 'Verify UI stability when rapidly clicking Card View and List View toggle icons.' } }, async ({ page }) => {
