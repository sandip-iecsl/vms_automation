 ...
 * Description: Verify clicking \'ADD CATEGORY\' opens the add category form modal/drawer.
 */
test('TC_108: Modal / Drawer Opening', { annotation: { type: 'description', description: 'Verify clicking \'ADD CATEGORY\' opens the add category form modal/drawer.' } }, async ({ page }) => {
