 ...
 */
test('TC_143: Row Selection & Highlighting', { annotation: { type: 'description', description: 'Verify clicking a row selects and highlights it with counter update.' } }, async ({ page }) => {
