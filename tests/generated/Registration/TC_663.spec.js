 ...
 */
test('TC_663: Tab Key Order Across Card Scan Form', { annotation: { type: 'description', description: 'Verify keyboard Tab navigation traverses all form fields sequentially.' } }, async ({ page }) => {
