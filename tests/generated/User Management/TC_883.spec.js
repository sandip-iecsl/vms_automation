 ...
 * Scenario: User Mapping Permission Matrix
 * Description: Verify configuring permissions for User Mapping screen.
 */
test('TC_883: User Mapping Permission Matrix', { annotation: { type: 'description', description: 'Verify configuring permissions for User Mapping screen.' } }, async ({ page }) => {
