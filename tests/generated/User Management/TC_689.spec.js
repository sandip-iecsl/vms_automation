 ...
 * Description: Verify visual layout, buttons, table columns, and alignment.
 */
test('TC_689: UI Elements & Header Buttons', { annotation: { type: 'description', description: 'Verify visual layout, buttons, table columns, and alignment.' } }, async ({ page }) => {
