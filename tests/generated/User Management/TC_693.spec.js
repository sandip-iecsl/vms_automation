 ...
 * Description: Verify validation when submitting an empty Group Name.
 */
test('TC_693: Blank Field Validation', { annotation: { type: 'description', description: 'Verify validation when submitting an empty Group Name.' } }, async ({ page }) => {
