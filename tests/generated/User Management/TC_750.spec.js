 ...
 * Scenario: Keyboard Quick Selection
 * Description: Verify keyboard navigation within Group dropdown options.
 */
test('TC_750: Keyboard Quick Selection', { annotation: { type: 'description', description: 'Verify keyboard navigation within Group dropdown options.' } }, async ({ page }) => {
