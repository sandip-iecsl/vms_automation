 ...
 * Description: Verify clicking CANCEL closes the modal without creating a mapping.
 */
test('TC_755: Cancel Modal Action', { annotation: { type: 'description', description: 'Verify clicking CANCEL closes the modal without creating a mapping.' } }, async ({ page }) => {
