 ...
 * Scenario: Valid User Mapping Creation
 * Description: Verify mapping a valid user to a selected role group.
 */
test('TC_751: Valid User Mapping Creation', { annotation: { type: 'description', description: 'Verify mapping a valid user to a selected role group.' } }, async ({ page }) => {
