 ...
 */
test('TC_1292: Profile Menu Logout Action', { annotation: { type: 'description', description: 'Verify clicking Logout from top right user menu invalidates session.' } }, async ({ page }) => {
